...
def main():
    ...
    appearance_image = pygame.image.load(
        r"D:\Python\tank\TankWar\image\appear.png").convert_alpha()
    appearance = []
            ...
            if each.flash:
                if each.bullet.life:
                    ...
                    if pygame.sprite.spritecollide(
                            each.bullet, bgMap.brickGroup, True, None):
                        each.bullet.life = False
                    # 子弹 碰撞 ironGroup
                    if each.bullet.strong:
                        if pygame.sprite.spritecollide(
                                each.bullet, bgMap.ironGroup, True, None):
                            each.bullet.life = False
                    else:
                        if pygame.sprite.spritecollide(
                                each.bullet, bgMap.ironGroup, False, None):
                            each.bullet.life = False
